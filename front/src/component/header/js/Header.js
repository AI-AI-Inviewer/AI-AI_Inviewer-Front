...
// 로그인 확인 로직을 캡슐화한 별도 컴포넌트
const AuthLink = ({ to, children, isLoggedIn, closeMenus }) => {
    const navigate = useNavigate();
    const authRequired = new Set(["/AiInviewer", "/mypage", "/feedback/write", "/postscript/write", "/CL"]);
                            ...
                            <ul className="dropdown-menu">
                                <li>
                                    <AuthLink to="/feedback" isLoggedIn={isLoggedIn} closeMenus={closeAllMenus}>
                                        <svg className="icon-svg" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14l4 4V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"></path></svg>
                                        자유 게시판
                                    </AuthLink>
                                </li>
                                <li>
                                    <AuthLink to="/postscript" isLoggedIn={isLoggedIn} closeMenus={closeAllMenus}>
                                        <svg className="icon-svg" viewBox="0 0 24 24"><path d="M14 17H4v2h10v-2zm6-8H4v2h16V9zM4 15h16v-2H4v2zM4 5v2h16V5H4z"></path></svg>
                                        면접 후기
                                    </AuthLink>
                                </li>
                            </ul>
                                ...
                                <ul className="dropdown-menu">
                                    <li>
                                        <AuthLink to="/mypage" isLoggedIn={isLoggedIn} closeMenus={closeAllMenus}>
                                            <svg className="icon-svg" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"></path></svg>
                                            마이페이지
                                        </AuthLink>
                                    </li>
                                    <li>
                                        <button className="btn-logout" onClick={handleLogout}>
                                            <svg className="icon-svg" viewBox="0 0 24 24"><path d="M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"></path></svg>
                                            로그아웃
                                        </button>
                                    </li>
                                </ul>
